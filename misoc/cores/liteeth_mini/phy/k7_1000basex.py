...
class K7_1000BASEX(Module):
    ...
    def __init__(self, refclk_or_clk_pads, data_pads, sys_clk_freq):
        ...
        pll = GTXChannelPLL(refclk, 125e6, 1.25e9)
        ...
        gtx_params.update(
            ...
            i_EYESCANRESET                   =0,
            i_RXUSERRDY                      =self.rx_mmcm_locked,
            ...
            # Receive Ports -RX Initialization and Reset Ports
            o_RXRESETDONE                    =self.rx_reset_done,
            ...
            i_CFGRESET                       =0,
            i_GTTXRESET                      =self.tx_reset,
            #o_PCSRSVDOUT                     =,
            i_TXUSERRDY                      =self.tx_mmcm_locked,
            ...
            i_TXPCSRESET                     =0,
            i_TXPMARESET                     =0,
            o_TXRESETDONE                    =self.tx_reset_done,
        ...
        self.specials += [
            ...
            AsyncResetSynchronizer(self.cd_eth_tx, ~self.tx_mmcm_locked)
        ]
        ...
        self.comb += [
            ...
            self.tx_reset.eq(tx_init.gtXxreset)
        ]
        ...
        self.comb += [
            ...
            self.rx_reset.eq(rx_init.gtXxreset)
        ]
